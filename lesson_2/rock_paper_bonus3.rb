...
# win logic symbol: beats [element]
win_logic = {
...
loop do
  ...
  puts "You chose #{player_choice.capitalize}; Computer chose #{computer_choice.capitalize}"

  if win_logic[player_choice.to_sym].include?(computer_choice)
      msg_to_user "You won!"
      player_score += 1
